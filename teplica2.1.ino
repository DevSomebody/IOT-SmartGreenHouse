...
#define SOIL_PIN 4    // Пин, к которому подключен датчик влажности почвы
#define LIGHT_PIN 35   // Пин, к которому подключен фоторезистор
#define FAN_PIN 2   // Пин, к которому подключен кулер
...
// Функция для отправки данных на MQTT брокер
  ...
  int soil_moisture = digitalRead(SOIL_PIN);
...
//  Serial.println(light_intensity_topic);
//  Serial.println(soil_moisture_topic);
